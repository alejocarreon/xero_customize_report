   ...
   <div class="panel panel-post panel-main-post">
      <div class="panel-body">
         ...
         <form class="post-announcement-form" method="post">
            <input type="hidden" name="post_id" value="<?php echo $postid; ?>" class="post_id"/>
            <textarea placeholder="Post announcement here..." name="post_announcement"  style="height: 100px;margin-bottom: 15px;" id="post-announcement" class="form-control post-announcement"></textarea>
         </form>
      ...
      <div class="panel-footer">
         <div class="row">
            <div class="col-4">
               <a href="<?php echo $postid; ?>" title="ADD PHOTOS" class="font-icon attached-image tooltip-title"><i class="fas fa-images" aria-hidden="true"></i></a>
               <a href="<?php echo $postid; ?>" title="ADD VIDEOS" class="font-icon attached-video tooltip-title"><i class="fas fa-video" aria-hidden="true"></i></a>
               <a href="<?php echo $postid; ?>" title="TAG YOUR TEAMATES" class="font-icon tag-group tooltip-title"><i class="fa fa-users" aria-hidden="true"></i></a>
            </div>
            <div class="col-8 text-right">
               <button class="btn btn-info btn-sm btn-post-announcement">Post Announcement</button>
            </div>
         </div>   
      </div>
   </div>
