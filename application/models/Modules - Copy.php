...
class Modules extends CI_Model {
    ...
    function template_reports($id,  $date, $client){
      ob_start();
      ?>
        <table>
              <tr>
                  <td></td>
                  <td></td>
                  <td style="heigth:30px !important;" valign="top">
                    ...
                    //  if($value['Title'] == "Property, Plant and Equipment" ||
                      //   $value['Title'] == "Cash and Cash Equivalents" ||
                      //   $value['Title'] == "Current Assets"){
                                   ...
                                   foreach ($getCells as $key => $cellvaluesmany) {
                                       ...
                                       if($count_td != 4 ){
                                         if (isset($cellvaluesmany['Value'])) {
                                             echo "<td class='hide_content_".$count_td."'>" . $cellvaluesmany['Value'] . "</td>";
